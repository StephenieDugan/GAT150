...
namespace Twili
{
    ...
    bool GAAAAME::Init()
    {
        ...
        m_Livestext = std::make_unique<Text>(font);
        ...
        //add events
        EVENT_SUBSCRIBE("AddPoints", GAAAAME::AddPoints);
        EVENT_SUBSCRIBE("onPlayerDeath", GAAAAME::onPlayerDeath);
    ...
    void GAAAAME::Update(float dt)
    {
        ...
        case GAAAAME::eState::Title:
            ...
            if (Twili::g_inputSys.GetKeyDown(SDL_SCANCODE_SPACE))
            {
                ...
                m_scene->getActorByName("spaceBackground")->active = false;
            }
            break;
        ...
        case GAAAAME::eState::Level1:
            ...
            if (m_spawn_timer >= m_spawnTime)
            {
                ...
                enemy->transform = { { Twili::random(800), Twili::random(600) }, Twili::randomF(Twili::pi2), 6 };
                enemy->Init();
        ...
        case GAAAAME::eState::Level2: //Add Enemy 2
        {
            ...
            if (m_spawn_timer >= m_spawnTime)
            {
                ...
                enemy2->transform = { { Twili::random(800), Twili::random(600) }, Twili::randomF(Twili::pi2), 6 };
                enemy2->Init();
        ...
        case GAAAAME::eState::Level3://Add Enemy 3: slower ships but beefier health
        {
            ...
            if (m_spawn_timer >= m_spawnTime)
            {
                ...
                enemy3->transform = { { Twili::random(800), Twili::random(600) }, Twili::randomF(Twili::pi2), 6 };
                enemy3->Init();
        ...
        case GAAAAME::eState::Level4://Add Enemy 4: similar to #3 but more extremes
            ...
            if (m_spawn_timer >= m_spawnTime)
            {
                ...
                enemy4->transform = { { Twili::random(800), Twili::random(600) }, Twili::randomF(Twili::pi2), 6 };
                enemy4->Init();
        ...
        case GAAAAME::eState::Level5:
        {
            ...
            if (m_spawn_timer >= m_spawnTime)
            {
                ...
                enemy5->transform = { { Twili::random(800), Twili::random(600) }, Twili::randomF(Twili::pi2), 6 };
                enemy5->Init();
    ...
    void GAAAAME::AddPoints(const Twili::Event& event)
    {
        m_score += std::get<int>(event.data);

    }

    void GAAAAME::onPlayerDeath(const Twili::Event& event)
    {
        m_lives--;
